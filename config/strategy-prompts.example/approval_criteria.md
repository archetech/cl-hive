...
## Node Context (YOUR-NODE-NAME)

- **Capacity**: ~XXM sats across N channels (~X.XM avg channel size)
- **On-chain**: ~X.XM sats available
- **Health**: X% profitable, Y% underwater, Z% stagnant - [your strategy focus]
- **Strategy**: [Describe your node's current strategic focus]
...
1. **Profitability Focus**: Prioritize fixing existing channels over expansion
2. **Cost Discipline**: Every sat of cost matters significantly
...
5. **Low Fee Environment**: Be opportunistic on opens when mempool clears
6. **Bleeder Awareness**: Avoid actions that could worsen problem channels
