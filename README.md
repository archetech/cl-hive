...
- **cl-hive-comms**: Required for Nostr transport (Phase 6+). `cl-hive` no longer runs an internal Nostr transport.
...
| `hive-phase6-plugins` | Show detected sibling plugin status/capabilities (`cl-hive-comms`, `cl-hive-archon`) |
